const COURSES = [
  {
    ...
    cat: "web",
    desc: "HTML, CSS, JS — build responsive pages.",
    duration: "6 wks",
    level: "Beginner",
  },
  {
    ...
    cat: "web",
    desc: "Frontend + Node basics + DB mini project.",
    duration: "10 wks",
    level: "Intermediate",
  },
  {
    ...
    cat: "dsa",
    desc: "Arrays, stacks, trees, graphs, complexity.",
    duration: "8 wks",
    level: "Intermediate",
  },
  {
    ...
    cat: "ai",
    desc: "Python, pandas, scikit-learn, mini models.",
    duration: "8 wks",
    level: "Intermediate",
  },
  {
    id: "data-anal",
    title: "Data Analytics (Excel+Py)",
    cat: "data",
    desc: "Clean, analyze, visualize data. Excel + Python.",
    duration: "5 wks",
    level: "Beginner",
  },
  {
    ...
    cat: "office",
    desc: "Word, Excel, PowerPoint for workplace.",
    duration: "4 wks",
    level: "Beginner",
  },
  {
    ...
    cat: "other",
    desc: "Resume, communication, mock interviews.",
    duration: "2 wks",
    level: "All",
  },
];
  ...
  filtered.forEach((c) => {
    ...
    card.innerHTML = `
      ...
      <div class="course-actions">
        ...
        <button class="fav-btn ${favs.has(c.id) ? "active" : ""}" data-fav="${
      c.id
